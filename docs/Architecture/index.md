...
- [Vipkey Runtime Architecture](#table-of-contents)
  ...
  - [4. Startup Sequences](#4-startup-sequences)
  - [5. Runtime Behavior](#5-runtime-behavior)
  - [6. Failure Handling](#6-failure-handling)
  - [7. State Isolation](#7-state-isolation)
  - [8. Named Event Protocol](#8-named-event-protocol)
  - [9. Security Considerations](#9-security-considerations)
  - [10. Summary: The Two Questions](#10-summary-the-two-questions)
